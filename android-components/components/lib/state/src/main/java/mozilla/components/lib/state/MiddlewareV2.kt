 ...
 */
typealias MiddlewareV2<S, A> = (context: MiddlewareContextV2<S, A>, next: (A) -> Unit, action: A) -> Unit
 ...
 */
interface MiddlewareContextV2<S : State, A : Action> {
    /**
